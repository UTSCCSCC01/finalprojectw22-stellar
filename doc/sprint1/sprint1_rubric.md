...
Your Mark: 2 (not enough specific references to user stories)
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 1 (no task breakdown, team capacity should be identified with points, not hours)
...
## Daily Stand-ups (max 10 marks)
  ...
  -2 for two missing standup messages
  -3 for vague standup messages
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 1 (many tasks not assigned to members)
...
Tracking on Jira Total Mark: 4 / 20
