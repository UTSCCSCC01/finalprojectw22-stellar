...
## Notes
- The task breakdown should be listed in sprint4.md (not just the user stories)
- Missing user story template in quite a few tasks listed on Jira (STEL-48, 49, 50)
- Many of stories don't have subtasks listed on Jira
- Missing COS (STEL-48, 49, 50)
- Not all tasks are completed on Jira (Some are still listed as To Do)
- You should describe/make clear of what your critical path is
- Stel-43 and 48 should be separate pull requests on different branches rather than in 1 PR on 1 branch all together
- Quite a few git messages don't begin with the ticket number